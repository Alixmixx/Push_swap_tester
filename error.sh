...
echo " -- test 3 4 1 2 3 --"
valgrind --leak-check=full ../push_swap 3 4 1 2 3
echo " -- test 0 3 2 0 --"
valgrind --leak-check=full ../push_swap 0 3 2 0
echo " -- test a 3 2 4 5 --"
valgrind --leak-check=full ../push_swap a 3 2 4 5
echo " -- test -++-123 55 489 --"
valgrind --leak-check=full ../push_swap -++-123 55 489
echo " -- test miao --"
...
echo " -- test random input --"
valgrind --leak-check=full ../push_swap $(tr -dc 'A-Za-z0-9!"#$%&'\''()*+,-./:;<=>?@[\]^_`{|}~' </dev/urandom | head -c 20  ; echo) $(tr -dc 'A-Za-z0-9!"#$%&'\''()*+,-./:;<=>?@[\]^_`{|}~' </dev/urandom | head -c 20  ; echo) $(tr -dc 'A-Za-z0-9!"#$%&'\''()*+,-./:;<=>?@[\]^_`{|}~' </dev/urandom | head -c 20  ; echo) $(tr -dc 'A-Za-z0-9!"#$%&'\''()*+,-./:;<=>?@[\]^_`{|}~' </dev/urandom | head -c 20  ; echo)
echo " -- test random input --"
valgrind --leak-check=full ../push_swap $(tr -dc 'A-Za-z0-9!"#$%&'\''()*+,-./:;<=>?@[\]^_`{|}~' </dev/urandom | head -c 20  ; echo) $(tr -dc 'A-Za-z0-9!"#$%&'\''()*+,-./:;<=>?@[\]^_`{|}~' </dev/urandom | head -c 20  ; echo) $(tr -dc 'A-Za-z0-9!"#$%&'\''()*+,-./:;<=>?@[\]^_`{|}~' </dev/urandom | head -c 20  ; echo) $(tr -dc 'A-Za-z0-9!"#$%&'\''()*+,-./:;<=>?@[\]^_`{|}~' </dev/urandom | head -c 20  ; echo)
echo " -- test random input --"
valgrind --leak-check=full ../push_swap $(tr -dc 'A-Za-z0-9!"#$%&'\''()*+,-./:;<=>?@[\]^_`{|}~' </dev/urandom | head -c 20  ; echo) $(tr -dc 'A-Za-z0-9!"#$%&'\''()*+,-./:;<=>?@[\]^_`{|}~' </dev/urandom | head -c 20  ; echo) $(tr -dc 'A-Za-z0-9!"#$%&'\''()*+,-./:;<=>?@[\]^_`{|}~' </dev/urandom | head -c 20  ; echo) $(tr -dc 'A-Za-z0-9!"#$%&'\''()*+,-./:;<=>?@[\]^_`{|}~' </dev/urandom | head -c 20  ; echo)
